---
name: unslop
description: Edit documentation and other writing intended for other people to remove AI patterns while preserving facts, technical details, and clear full sentences. Use for READMEs, guides, reports, PRs, issues, emails, and shared prose. Do not apply to ordinary Caveman chat replies.
---
...
## Local scope and preservation

Apply to shared prose, including documents drafted inside a chat response. Ordinary chat replies use the user's chosen Caveman style instead. In a mixed response, edit the document in normal prose and keep the surrounding chat concise.

Preserve supported facts, necessary context, uncertainty, negations, conditions, and technical terminology. Never invent evidence, numbers, citations, anecdotes, or claims to satisfy a style rule. Keep code, commands, paths, URLs, quotations, and structured data unchanged unless the user requests changes to them. Style rules do not justify dropping useful information. Match an explicit audience or writing sample when provided. Return the final prose without a draft or audit unless requested.

Source: https://github.com/cursor/plugins/tree/main/pstack/skills/unslop
Local adaptation: audience scope, automatic discovery, and preservation rules.
